...
## The new version 1.1 of the Atlas is now available! 
...
The DNA-barcodes are used to generate The version 1.1 of the Atlas of mitochondrial genetic diversity for Western Palearctic butterflies that can be freely downloaded from this link:<br>
https://drive.google.com/file/d/1KmXTsYHdC3pi-EdstbaeXpQSz0ULnsVv/view?usp=drive_link
<br>
